...
#define WIND_WIDTH_SMS 1275
#define WIND_HEIGHT_SMS 960

#define WIND_WIDTH_GG 1120
#define WIND_HEIGHT_GG 820
...
int main(int argc, char** argv)
{
	...
	if (tripled) {
		...
		if (MastEx&MX_GG) {
			width=WIND_WIDTH_GG;
			height=WIND_HEIGHT_GG;
		}
		else {
			width=WIND_WIDTH_SMS;
			height=WIND_HEIGHT_SMS;
		}
	}
    ...
    /* or using the default masks for the depth: */
        if (fsJoe == 1) {
            ...
            if (MastEx&MX_GG) {
               thescreen=SDL_CreateRGBSurface(SDL_HWSURFACE ,WIND_WIDTH_GG,WIND_HEIGHT_GG,8,0,0,0,0);
               //Create The Window as a fullscreen window with OPENGL
               theWindow=SDL_CreateWindow("DegaJoe with SDL 1.3",0,0,WIND_WIDTH_GG,WIND_HEIGHT_GG,SDL_WINDOW_OPENGL);
            } else {
                 thescreen=SDL_CreateRGBSurface(SDL_SWSURFACE ,WIND_WIDTH_SMS,WIND_HEIGHT_SMS,8,0,0,0,0);
               //Create The Window as a fullscreen window with OPENGL
               theWindow=SDL_CreateWindow("DegaJoe with SDL 1.3",0,0,WIND_WIDTH_SMS,WIND_HEIGHT_SMS,SDL_WINDOW_OPENGL);
            } 
